...
public class AppModule
{
	 ...
	 * InternalConstants.TAPESTRY_APP_PACKAGE_PARAM + ".entities" (witch is equal to "test5.tynamo.entities")
	 * for annotated entity classes.
	 *
	 * Contributes the package "test5.tynamo.model" to the configuration, so that it will be
	 * scanned for annotated entity classes.
	 */
	public static void contributeHibernateEntityPackageManager(Configuration<String> configuration)
	{
//		If you want to scan other packages add them here:
//		configuration.add("test5.tynamo.model");
	}
